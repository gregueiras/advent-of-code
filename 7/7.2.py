...
# Not completed, I would have to change too many things
...
def script():
    ...
    permutations = list(itertools.permutations([9, 8, 7, 6, 5]))
    ...
    for combination in permutations:
        ...
        while (True):
            for phase in combination:
                ...
                tempOutput = iter(phase, outputValue)

                if (tempOutput is None):
                    print("END")
                    break
                else:
